...
@section('conteudo') 
    ...
    <section id="team">
        ...
        <div class="photo-container">
            ...
            <div class="photo">
                <img src="img/torre_unesp.jpg" alt="Imagem Descritiva">
            </div>
        </div>
        <div class="photo-container">
            <div class="description">
